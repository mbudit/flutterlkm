...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.5)),
  );
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 32.0, fontWeight: FontWeight.normal, color: Colors.white),
    labelMedium: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.5)),
  );
}